...
# Use its output to guide your analysis of the results of running ./wpi-many.sh. This script
# automatically categorizes projects that failed to build, projects that do not have a maven or
# gradle build file, and projects that timed out. The rest of the projects are reported as
# "results available": these are the projects for which the checker produced output. This script
# makes no attempt to categorize these projects: a human should inspect these log files/projects
# to see the results.
